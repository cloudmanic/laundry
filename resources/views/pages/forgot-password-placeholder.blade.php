{{--
    File: forgot-password-placeholder.blade.php
    Description: Placeholder page for forgot password functionality
...
<div class="min-h-screen flex items-center justify-center bg-slate-50 px-4">
    <div class="max-w-md w-full text-center">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <h1 class="text-2xl font-bold text-slate-900 mb-4">Forgot Password</h1>
