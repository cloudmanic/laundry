{{--
    ...
    Description: Branded password reset email template with region-specific styling
...
<body style="margin: 0; padding: 0; background-color: #f8fafc; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    ...
    <div style="display: none; max-height: 0px; overflow: hidden;">
        Reset your {{ $city['brand'] }} password - this link expires in 60 minutes
    </div>
                    ...
                    <tr>
                        <td style="padding: 40px;" class="mobile-padding">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: 0 auto 24px auto;">
                                <tr>
                                    <td style="background-color: #ecfdf5; width: 64px; height: 64px; border-radius: 50%; text-align: center; vertical-align: middle;">
                                        <!-- Key Icon -->
                                        <img src="https://cdn-icons-png.flaticon.com/512/6195/6195699.png" alt="Reset Password" width="32" height="32" style="display: inline-block;" />
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 24px; color: #475569;">
                                We received a request to reset your password for your {{ $city['brand'] }} account. Click the button below to create a new password:
                            </p>
                    ...
                    <tr>
                        <td style="text-align: center; padding: 0 20px;">
                            <p style="margin: 0; font-size: 11px; line-height: 16px; color: #94a3b8;">
                                This email was sent to you because a password reset was requested for your {{ $city['brand'] }} account.
