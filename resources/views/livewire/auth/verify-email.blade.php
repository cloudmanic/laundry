{{--
    ...
    Description: Sales-focused email verification notice page with Livewire resend functionality
    Copyright: 2026 Cloudmanic Labs, LLC
    Date: 2026-01-22
--}}
<div class="min-h-screen flex flex-col lg:flex-row">
    {{-- Left Side: Verification Notice --}}
        ...
        <div class="w-full max-w-md mx-auto">
            ...
            <div class="mb-8">
                <div class="flex items-center space-x-2 text-sm text-slate-500 mb-2">
                    ...
                    <span class="font-medium text-emerald-600">Email Verification</span>
                </div>
            </div>
            ...
            <div class="text-center">
                ...
                <p class="text-slate-600 mb-6">
                    We've sent a verification link to <span class="font-semibold text-slate-900">{{ $user->email }}</span>. Please click the link to verify your email address.
                </p>
                ...
                @if($emailResent)
                    ...
                    <div class="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-6">
                        <div class="flex items-center justify-center space-x-2 text-emerald-700">
                            ...
                            <span class="font-semibold">Verification email sent!</span>
                        </div>
                ...
                @if($errorMessage)
                    ...
                    <div class="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
                        <div class="flex items-center justify-center space-x-2 text-red-700">
                            ...
                            <span class="font-semibold">Unable to resend</span>
                        </div>
                ...
                <div class="space-y-3">
                    @if(!$emailResent)
                        ...
                        >
                            ...
                            <span wire:loading.flex wire:target="resendVerificationEmail" class="items-center justify-center gap-2">
                    ...
                    @else
                        <button
                            type="button"
                            wire:click="resetEmailResentState"
                            class="w-full bg-emerald-600 text-white py-4 rounded-xl font-bold text-lg hover:bg-emerald-700 transition-all transform hover:-translate-y-0.5 shadow-lg shadow-emerald-600/30"
                        >
                            Send Another Email
                        </button>
                    @endif
        ...
        <div class="relative z-10 max-w-lg">
            ...
            <div class="bg-white/10 backdrop-blur rounded-2xl p-6 mb-8 border border-white/20">
                <div class="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl font-bold">Just One More Step</h3>
                    </div>
                </div>
                <p class="text-slate-300 text-sm">
                    Verifying your email helps us keep your account secure and ensures you receive important updates about your laundry service.
                </p>
            </div>
            ...
            <ul class="space-y-4 mb-10">
                <li class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-slate-400 text-sm">Look for an email from {{ $city['brand'] }}</p>
                    </div>
                </li>
                <li class="flex items-start space-x-3">
                    <div class="flex-shrink-0 w-8 h-8 rounded-full bg-emerald-500 flex items-center justify-center mt-0.5 text-sm font-bold">
                    ...
                    <div>
                        <p class="font-semibold">Click the Verification Link</p>
                        <p class="text-slate-400 text-sm">One click to confirm your email address</p>
                    </div>
                </li>
                <li class="flex items-start space-x-3">
                    <div class="flex-shrink-0 w-8 h-8 rounded-full bg-emerald-500 flex items-center justify-center mt-0.5 text-sm font-bold">
                    ...
                    <div>
                        <p class="font-semibold">Complete Your Setup</p>
                        <p class="text-slate-400 text-sm">Add your address and choose your plan</p>
                    </div>
                </li>
                <li class="flex items-start space-x-3">
                    <div class="flex-shrink-0 w-8 h-8 rounded-full bg-emerald-500 flex items-center justify-center mt-0.5 text-sm font-bold">
                    ...
                    <div>
                        <p class="font-semibold">Enjoy Fresh Laundry</p>
                        <p class="text-slate-400 text-sm">Schedule your first pickup and relax!</p>
                    </div>
                </li>
            </ul>
            ...
            <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                <div class="flex items-center space-x-3 mb-3">
                    ...
                    <p class="font-semibold">Didn't Receive the Email?</p>
                </div>
                <p class="text-slate-400 text-sm">
                    Check your spam or junk folder. If you still can't find it, click the resend button or contact us at
